...
class Game:
    ...
    def display_car(self, position):
        ...
        print("Car rect: ", self.car.rect.center)
            ...
            while self.running:
                ...
                if self.start and not self.finished:
                    if not self.car.polygon.intersection(self.finish_point):
                        ...
                        # print(
                        #     f'distance_light: {variables["distance_light"]}',
                        #     f'distance_obstacle: {variables["distance_obstacle"]}',
                        #     f'light_status: {variables["light_status"]}'
                        #     f'speed: {speed}',
                        #     f'steering: {steering}, angle {steering_angle}',
                        #     # f'acceleration: {self.car.acceleration}'
                        # )
                    else:
                        self.finished = True
